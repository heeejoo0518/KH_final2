 	...
 	<div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-black" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a id="update-list-item" class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">내 정보 수정</a>
                <a id="review-list-item" class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">내가 쓴 리뷰</a>
                <a id="like-list-item" class="list-group-item list-group-item-action list-group-item-light p-3" href="#!">내가 찜한 영화</a>
            </div>
        </div>
