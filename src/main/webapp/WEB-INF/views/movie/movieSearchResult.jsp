				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<div class="movie-item-style-2">
						...
						<div class="mv-item-infor">
							<c:forEach var="movie" items="${ list }">
								<h6>
									<a href="${ path }/movie/view?no=${ movie.movie_id }"><c:out
											value="${ movie.title }" /><span>${ movie.product_year }</span></a>
								</h6>
								<p class="rate">
									<i class="ion-android-star"></i>모영별점: <span>8.0</span> /10
								</p>
								<p class="review">
									<i class="ion-edit"></i><span class="rv"> 56개의 리뷰</span> <br>
									<br> <a href="https://www.netflix.com/"><img
										src="${ path }/images/netflix.jpg" alt="neflogo"
										style="width: 50px; height: 50px"></a> <img
										src="${ path }/images/watcha.jpg" alt="watlogo"
										style="width: 50px; height: 50px"> <img
										src="${ path }/images/tving.jpg" alt="tvlogo"
										style="width: 50px; height: 50px"> <img
										src="${ path }/images/wavve.jpg" alt="wavlogo"
					...
					<div class="movie-item-style-2">
						<c:forEach var="movie" items="${ list }">
							...
							<div class="mv-item-infor">
								<h6>
									<a href="movieDetail"><c:out value="${ movie.title }" /><span><c:out
												value="${ movie.open_date }" /></span></a>
								</h6>
								<p class="rate">
									<i class="ion-android-star"></i>모영별점: <span><c:out
											value="${ movie.vote }" /></span> /10
								</p>
								<p class="review">
									<i class="ion-edit"></i><span class="rv"> 56개의 리뷰</span> <br>
									<br> <a href="https://www.netflix.com/"><img
					...
					<div class="movie-item-style-2">
						...
						<div class="mv-item-infor">
							<h6>
								<a href="movieDetail"><c:out value="영화제목" /><span>(개봉년도)</span></a>
							</h6>
							<p class="rate">
								<i class="ion-android-star"></i>모영별점: <span>8.0</span> /10
							</p>
